...
//   相册列表页面右边箭头图片
#define PhotoListRightBtn  EXBundleImageNamed(@"zz_alumb_rightCell.png")
//   相册列表页面，当没有数据时使用图片
#define NOPhoto_Data_Pic  EXBundleImageNamed(@"no_data.png")
//   图片选中状态图片
#define Pic_Btn_Selected    EXBundleImageNamed(@"select_yes.png")
//   图片未选中状态图片
#define Pic_btn_UnSelected   EXBundleImageNamed(@"select_no.png")

//   拍照图片
#define TakePhoto_Btn_Pic EXBundleImageNamed(@"take_photo_pic.png")
//   闪光灯按钮图片
#define Flash_Open_Btn_Pic  EXBundleImageNamed(@"flash_open_pic.png")
#define Flash_close_Btn_Pic EXBundleImageNamed(@"flash_close_pic.png")
//   切换前置后置摄像头按钮
#define Change_Btn_Pic  EXBundleImageNamed(@"change_camera_pic.png")        
//   删除图片按钮
#define Remove_Btn_Pic   EXBundleImageNamed(@"remove_btn_pic.png")      
