...
- (void)setPlaceHolderLabel:(NSString *)placeholder {
    ...
    self.placeholderLabel.frame = CGRectMake(10, 7, rect.size.width + 50, rect.size.height);
...
- (void)setWordcountLable:(NSNumber *)limitLength {
     ...
     *  字数限制
     */
    self.wordCountLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.frame) - 75, CGRectGetHeight(self.frame) - 35, 60, 20)];
