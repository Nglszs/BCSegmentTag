...
+ (void)show:(NSString *)text icon:(NSString *)icon view:(UIView *)view{
    ...
    hub.label.text = text;
    // 设置图标
    hub.customView = [[UIImageView alloc] initWithImage:[UIImage iconWithInfo:TBCityIconInfoMake([icon isEqualToString: @"error.png"] ? @"\U0000e681" : @"\U0000e682", 34,KColor(102, 102, 102, 1.0))]];
    // 在设置模式
