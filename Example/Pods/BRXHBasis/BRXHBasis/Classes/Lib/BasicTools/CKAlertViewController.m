...
- (void)viewDidLoad {
    [super viewDidLoad];
    UIView *bg=[[UIView alloc]initWithFrame:CGRectMake(0.0,0.0,SCREEN_W , SCREEN_H)];
    [bg setBackgroundColor:[UIColor blackColor]];
    [bg setAlpha:0.3];
    
    UIToolbar *toolbar = [[UIToolbar alloc] initWithFrame:CGRectMake(0.0,0.0,SCREEN_W , SCREEN_H)];
...
- (void)creatAllButtons {
    ...
    for (int i=0; i<self.actions.count; i++) {
        ...
        btn.titleLabel.font = [UIFont customFontWithSize:15];
        ...
        [btn.titleLabel setFont:[UIFont customFontWithSize:15.0f]];
...
//  label.font = [UIFont systemFontOfSize:fontSize];
    label.font=[UIFont customFontWithSize:14.0f];
...
- (UILabel *)messageLabel {
    if (!_messageLabel) {
        ...
        _messageLabel.textAlignment = NSTextAlignmentCenter;//self.messageAlignment;
